      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-6 text-4xl sm:text-5xl lg:text-6xl lg:leading-normal font-extrabold">
            <span className=" bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-600 mb-2">
              Hello, I&apos;m{" "}
            </span>
            <br />
            <TypeAnimation
          ...
          <div>
            ...
            <Link
              href="https://static-resume-eta.vercel.app/"
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[350px] lg:h-[350px] relative">
            <Image
              ...
              alt="hero image"
              className="absolute p-8 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              width={300}
              height={300}
            />
          </div>
